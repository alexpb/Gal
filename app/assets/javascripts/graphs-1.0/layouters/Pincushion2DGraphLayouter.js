function Pincushion2DGraphLayouter(graph) {
    this.Graph = graph;
    this.NodeSpacing = 0;
    this.GraphRadius;
...
Pincushion2DGraphLayouter.prototype = new BaseGraphLayouter();
// correct the constructor pointer because it points to BaseGraphLayouter
Pincushion2DGraphLayouter.prototype.constructor = Pincushion2DGraphLayouter;