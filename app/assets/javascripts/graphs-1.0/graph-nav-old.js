function GraphNavToolbar(graph) {
    ...
    this._Create = function () {
        ...
        $('<div id="graph-nav-pan-up" class="graph-nav-tool graph-nav-pan-up" title="Pan up"></div>').appendTo($(panTools)).get(0)._PanDirection = 'up';
        ...
        $('<div id="graph-nav-pan-left" class="graph-nav-tool graph-nav-pan-left" title="Pan left"></div>').appendTo($(panTools)).get(0)._PanDirection = 'left';
        ...
        $('<div id="graph-nav-pan-right" class="graph-nav-tool graph-nav-pan-right" title="Pan right"></div>').appendTo($(panTools)).get(0)._PanDirection = 'right';
        ...
        $('<div id="graph-nav-pan-down" class="graph-nav-tool graph-nav-pan-down" title="Pan up"></div>').appendTo($(panTools)).get(0)._PanDirection = 'down';
